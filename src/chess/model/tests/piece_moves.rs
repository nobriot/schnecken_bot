...
fn check_knight_moves() {
  ...
  assert_eq!(expected_squares, get_knight_moves(0, 0, string_to_square("b3") as usize));
...
fn check_bishop_moves() {
  ...
  assert_eq!(expected_squares, get_bishop_moves(0, 0, string_to_square("b3") as usize));
  ...
  assert_eq!(expected_squares,
             get_bishop_moves(same_side_pieces, opponent_pieces, string_to_square("b3") as usize));
}
...
fn check_rook_moves() {
  ...
  let expected_squares: u64 = (1 << string_to_square("b5"))
                              ...
                              | (1 << string_to_square("c3"))
                              | (1 << string_to_square("d3"));
  let calculated_squares =
    get_rook_moves(same_side_pieces, opponent_pieces, string_to_square("b3") as usize);
...
fn check_king_moves() {
  ...
  let calculated_squares =
    get_king_moves(same_side_pieces, opponent_control, string_to_square("b3") as usize);
...
fn check_white_pawn_moves() {
  ...
  let calculated_squares =
    get_white_pawn_moves(same_side_pieces, opponent_pieces, string_to_square("a2") as usize);
  ...
  let calculated_squares =
    get_white_pawn_moves(same_side_pieces, opponent_pieces, string_to_square("d4") as usize);
...
fn check_black_pawn_moves() {
  ...
  let calculated_squares =
    get_black_pawn_moves(same_side_pieces, opponent_pieces, string_to_square("a7") as usize);
  ...
  let calculated_squares =
    get_black_pawn_moves(same_side_pieces, opponent_pieces, string_to_square("d6") as usize);
