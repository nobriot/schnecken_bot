...
fn piece_display_test() {
  let mut piece = Piece { p_type: PieceType::King,
                          color:  Color::White, };
...
#[test]
fn full_loop_u8() {
  let mut initial_piece = Piece { p_type: PieceType::King,
                                  color:  Color::White, };

  assert_eq!(initial_piece, Piece::from_u8(initial_piece.as_u8()).unwrap());
...
fn full_loop_char() {
  ...
  assert_eq!(initial_piece, Piece::from_char(initial_piece.as_char()).unwrap());
