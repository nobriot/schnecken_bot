...
/// Array of u64 (board bitmasks bitmasks indicating if a knight can move from a
/// square to another)
pub const KNIGHT_MOVES: [u64; 64] = [0x0000000000020400,
                                     0x0000000000050800,
                                     0x00000000000A1100,
                                     0x0000000000142200,
                                     0x0000000000284400,
...
pub const KING_MOVES: [u64; 64] = [0x0000000000000302,
                                   0x0000000000000705,
                                   0x0000000000000E0A,
                                   0x0000000000001C14,
                                   0x0000000000003828,
...
/// * `recursion` - can the piece continue going in one direction ? true or is
///   it only 1 jump: false
/// * `same_side_pieces` - boardmask of the same side pieces
/// * `opponent_pieces` - boardmask of the opponent pieces
/// * `square` - Start square for the knight
/// * `square` - Start square for the knight
pub fn get_moves_from_offsets(move_offsets: &[(isize, isize)],
                              recursion: bool,
...
///
/// NOTE: Make sure to add the en-passant square in the oppponent pieces board
/// mask
///
/// ### Arguments
///
...
#[inline]
pub fn get_white_pawn_moves(same_side_pieces: u64,
                            opponent_pieces: u64,
                            square: usize)
                            -> BoardMask {
...
/// Board mask with squares where the pawn can go.
#[inline]
pub fn get_black_pawn_moves(same_side_pieces: u64,
                            opponent_pieces: u64,
                            square: usize)
                            -> BoardMask {
  let mut destinations: u64 = 0;
