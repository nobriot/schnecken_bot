...
pub const BISHOP_SPAN: [u64; 64] = [0x8040201008040200,
                                    0x0080402010080500,
                                    0x0000804020110A00,
                                    0x0000008041221400,
                                    0x0000000182442800,
...
pub const BISHOP_SPAN_WITHOUT_EDGES: [u64; 64] = [0x0040201008040200,
                                                  0x0000402010080400,
                                                  0x0000004020100A00,
                                                  0x0000000040221400,
                                                  0x0000000002442800,
...
pub const BISHOP_SPAN_INDEXES: [[usize; 9]; 64] = [[9, 18, 27, 36, 45, 54, 255, 255, 255],
...
/// For a given position, this table indicate the Number of relevant blockers
/// bits for a bishop
...
pub const BISHOP_MAGIC: [u64; 64] = [0x4820021228210011,
                                     0x0010920801202000,
                                     0x0044110602000082,
                                     0x0054441080000281,
                                     0x0801104080000200,
...
pub fn get_bishop_destinations(same_side_pieces: BoardMask,
  ...
  unsafe {
    BISHOP_DESTINATION_TABLE.get_unchecked(square).get_unchecked(blockers_key) & !same_side_pieces
  }
}
