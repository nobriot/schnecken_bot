...
/// Edges are included.
pub const ROOK_SPAN: [u64; 64] = [0x01010101010101FE,
                                  0x02020202020202FD,
                                  0x04040404040404FB,
                                  0x08080808080808F7,
                                  0x10101010101010EF,
...
pub const ROOK_SPAN_WITHOUT_EDGES: [u64; 64] = [0x000101010101017E,
                                                0x000202020202027C,
                                                0x000404040404047A,
                                                0x0008080808080876,
                                                0x001010101010106E,
...
/// Rook Magic Numbers
pub const ROOK_MAGIC: [u64; 64] = [4719772549088624642,
                                   18014673924263938,
                                   72092778545299712,
                                   9835870382538654212,
                                   2341875121952129152,
...
pub fn get_rook_destinations(same_side_pieces: BoardMask,
  ...
  // The benchmarks show that get_unchecked here makes the function run a lot
  // faster than regular slice indexing
  #[allow(static_mut_refs)]
  unsafe {
    ROOK_DESTINATION_TABLE.get_unchecked(square).get_unchecked(blockers_key) & !same_side_pieces
  }
}
