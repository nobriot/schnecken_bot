use crate::model::board_mask::{print_board_mask, BoardMask};
...
/// Array of BoardMasks indicating where the rook can reach if there were no other pieces on the board
