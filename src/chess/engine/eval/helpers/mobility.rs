...
mod tests {
  ...
  fn test_mobility_area() {
    ...
    assert_eq!(46, get_mobility_area(&game_state, Color::White).count_ones());
    assert_eq!(44, get_mobility_area(&game_state, Color::Black).count_ones());
    ...
    assert_eq!(47, get_mobility_area(&game_state, Color::White).count_ones());
    assert_eq!(43, get_mobility_area(&game_state, Color::Black).count_ones());
  }
